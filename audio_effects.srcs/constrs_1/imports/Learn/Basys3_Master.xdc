...
set_property PACKAGE_PIN T3 [get_ports {rep}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rep}]
#set_property PACKAGE_PIN T2 [get_ports {sw[10]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[10]}]
set_property PACKAGE_PIN R3 [get_ports {delay_option[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {delay_option[0]}]
set_property PACKAGE_PIN W2 [get_ports {delay_option[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {delay_option[1]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports butreset]						
	set_property IOSTANDARD LVCMOS33 [get_ports butreset]
set_property PACKAGE_PIN T18 [get_ports butup]						
	set_property IOSTANDARD LVCMOS33 [get_ports butup]
#set_property PACKAGE_PIN W19 [get_ports btnL]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnL]
#set_property PACKAGE_PIN T17 [get_ports btnR]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnR]
set_property PACKAGE_PIN U17 [get_ports butdown]						
	set_property IOSTANDARD LVCMOS33 [get_ports butdown]
